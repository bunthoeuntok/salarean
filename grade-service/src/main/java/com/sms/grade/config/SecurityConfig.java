...
import com.sms.grade.security.JwtAuthenticationFilter;
...
/**
 * Security configuration for the Grade Service.
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        // Allow public access to subjects and assessment types (reference data)
                        .requestMatchers(
                                "/api/subjects/**",
