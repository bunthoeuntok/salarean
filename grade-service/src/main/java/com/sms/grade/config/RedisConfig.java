...
/**
 * Redis configuration for grade-service caching.
 *
 * <p>Configures RedisTemplate with JSON serialization for grade data caching.
 * Uses Jackson for object serialization to support complex DTOs and Java 8 time types.</p>
 *
 * <p><strong>Configuration</strong>:
 * <ul>
 *   <li>Key Serializer: String (for cache keys like "grade-service:teacher:{uuid}:grades")</li>
 *   <li>Value Serializer: JSON (for GradeResponse and other complex objects)</li>
