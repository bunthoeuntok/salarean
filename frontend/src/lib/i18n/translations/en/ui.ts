...
export const uiEn: UITranslations = {
  ...
  semesterConfig: {
    ...
    description: 'Configure exam schedule for each semester',
    academicYear: 'Academic Year',
    customConfig: 'Custom',
    availableExams: 'Available Exams',
    dragInstruction: 'Drag exams to assign to a semester',
    allAssigned: 'All exams assigned',
    monthlyExams: 'monthly exams',
    dropHere: 'Drop exams here',
