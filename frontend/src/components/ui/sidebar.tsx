...
// Counter for generating stable skeleton widths
let skeletonCounter = 0
const SKELETON_WIDTHS = ['50%', '65%', '75%', '60%', '80%', '55%', '70%', '85%', '58%', '72%']
...
function SidebarMenuSkeleton({
  ...
  // Use stable width from predefined list (cycles through options)
  const width = React.useMemo(() => {
    const index = skeletonCounter++ % SKELETON_WIDTHS.length
